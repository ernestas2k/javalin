 ...
 */
open class WsContext(val sessionId: String, session: Session, private val pathParamMap: Map<String, String>, private val matchedPath: String) {
...
class WsContextOnConnect(sessionId: String, session: Session, pathParamMap: Map<String, String>, matchedPath: String) : WsContext(sessionId, session, pathParamMap, matchedPath)
class WsContextOnException(sessionId: String, session: Session, pathParamMap: Map<String, String>, matchedPath: String, val error: Throwable?) : WsContext(sessionId, session, pathParamMap, matchedPath)
class WsContextOnClose(sessionId: String, session: Session, pathParamMap: Map<String, String>, matchedPath: String, val statusCode: Int, val reason: String?) : WsContext(sessionId, session, pathParamMap, matchedPath)
class WsContextOnBinaryMessage(sessionId: String, session: Session, pathParamMap: Map<String, String>, matchedPath: String, val msg: Array<Byte>, val offset: Int, val length: Int) : WsContext(sessionId, session, pathParamMap, matchedPath)
class WsContextOnMessage(sessionId: String, session: Session, pathParamMap: Map<String, String>, matchedPath: String, private val message: String?) : WsContext(sessionId, session, pathParamMap, matchedPath) {
